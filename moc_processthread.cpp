...
**
** Created: Thu Nov 18 17:46:45 2010
...
static const char qt_meta_stringdata_ProcessThread[] = {
    "ProcessThread\0\0,\0processFinished(int,int)\0"
    "processStuff(QImage)\0"
};
...
int ProcessThread::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: processFinished((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        case 1: processStuff((*reinterpret_cast< QImage(*)>(_a[1]))); break;
        default: ;
        }
        _id -= 2;
    }
...
// SIGNAL 0
void ProcessThread::processFinished(int _t1, int _t2)
{
