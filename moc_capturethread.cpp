...
static const char qt_meta_stringdata_CaptureThread[] = {
    "CaptureThread\0\0image\0renderedImage(QImage)\0"
};
...
int CaptureThread::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: renderedImage((*reinterpret_cast< const QImage(*)>(_a[1]))); break;
        default: ;
        }
        _id -= 1;
    }
...
// SIGNAL 0
void CaptureThread::renderedImage(const QImage & _t1)
{
